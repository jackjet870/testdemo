...
namespace ArchPack.ArchUnits.Data.Sql.V1
{
    ...
    /// </summary>
    public sealed class QueryClausePart
    {
        ...
        public QueryClausePart(DataQuery dataQuery)
        {
            Contract.NotNull(dataQuery, "dataQuery");

            this.dataQuery = dataQuery;
            this.Factory = dataQuery.Factory;
        }
        /// <summary>
        ...
        public DataQuery Build(bool appendWhere = true)
        {
            ...
            {
                this.dataQuery.AppendQuery(from);
            }
            ...
            if (!string.IsNullOrEmpty(where))
            {
                if (appendWhere)
                {
                    this.dataQuery.AppendQuery("WHERE 1 = 1");
                }
                this.dataQuery.AppendQuery("AND");
                this.dataQuery.AppendQuery("(" + this.WhereClause + ")");
            }
