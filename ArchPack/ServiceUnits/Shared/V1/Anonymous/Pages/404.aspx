<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="404.aspx.cs" Inherits="ArchPack.ServiceUnits.Shared.V1.Anonymous.Pages._404" %>
...
<head runat="server">
    ...
    <title><%=StringContents.NotFoundErrorTitle %></title>
...
<body>
    <div class="container">
        <div class="page-header">
            ...
            <h3 class="error-title-message"><%=StringContents.NotFoundErrorMessage %></h3>
        </div>
        <div class="" role="alert">
            <a href='<%=RedirectUrl %>'><%=StringContents.NotFoundErrorNavigationMessage %></a>
        </div>        
    </div>
