<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="500.aspx.cs" Inherits="ArchPack.ServiceUnits.Shared.V1.Anonymous.Pages._500" %>
...
<head runat="server">
    ...
    <title><%=StringContents.InternalServerErrorTitle %></title>
...
<body>
    <div class="content-wrap container">
        <div class="page-header">
            ...
            <h3 class="error-title-message"><%=StringContents.InternalServerErrorMessage %></h3>
        </div>
        <div class="" role="alert">
            <a href='<%=RedirectUrl %>'><%=StringContents.InternalServerErrorNavigationMessage %></a>
        </div>        
    </div>
