<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="ArchPack.ServiceUnits.Shared.V1.Anonymous.Pages.Login" %>
<%@ Import Namespace="ArchPack.ServiceUnits.Shared.V1.Resources" %>
...
<body>
    ...
    <script src="<%=this.ResolveSuitableFileUrl("~/Shared/V1/resource/StringContents?c=" + System.Threading.Thread.CurrentThread.CurrentUICulture.TwoLetterISOLanguageName) %>" type="text/javascript"></script>
    <script src="<%=this.ResolveSuitableFileUrl("~/Shared/V1/resource/Messages?c=" + System.Threading.Thread.CurrentThread.CurrentUICulture.TwoLetterISOLanguageName) %>" type="text/javascript"></script>
